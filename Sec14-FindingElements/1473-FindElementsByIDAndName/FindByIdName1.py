...
class FindByIdName():
    ...
    def test(self):
        ...
        driver.get(baseUrl)
        elementById = driver.find_element_by_id("edit-search-block-form--2")
        elementById1 = driver.find_element(By.XPATH, "im_field_role:94")
        elementById2 = driver.find_element()
        ...
        elementByClassName = driver.find_elements_by_class_name("search")
